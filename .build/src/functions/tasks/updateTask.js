...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var client, taskId, body, taskServices, getTaskById, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                client = (0, db_1.createDBClient)();
                taskId = (_a = event.pathParameters) === null || _a === void 0 ? void 0 : _a.id;
            ...
            case 2:
                ...
                return [4 /*yield*/, taskServices.getTaskById(taskId)];
            case 3:
                getTaskById = _b.sent();
                ...
                // Update task
                return [4 /*yield*/, taskServices.updateTaskById(taskId, body)];
            case 4:
                // Update task
                _b.sent();
                return [2 /*return*/, (0, response_1.response)(200, { message: "Updated task successfully." })];
            case 5:
                error_1 = _b.sent();
