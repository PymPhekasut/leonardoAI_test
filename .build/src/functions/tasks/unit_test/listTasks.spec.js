...
var listTasks_1 = require("../listTasks");
...
describe("handler", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, listTasks_1.handler)()];
                case 1:
                    result = _a.sent();
    ...
    it("should return 200 with list of tasks", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(tasks_1.TaskServices).toHaveBeenCalledWith(mockClient);
                    expect(mockTaskServices.listTasks).toHaveBeenCalled();
                    expect(response_1.response).toHaveBeenCalledWith(200, { tasks: mockTasks });
                    expect(result).toEqual({
                        statusCode: 200,
                        body: JSON.stringify({ tasks: mockTasks }),
                    });
...
//# sourceMappingURL=listTasks.spec.js.map