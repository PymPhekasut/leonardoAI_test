...
describe("handler", function () {
    ...
    it("should return 404 if no task found", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    tasks_1.TaskServices.mockImplementation(function () { return mockTaskServices; });
                    ...
                    return [4 /*yield*/, (0, deleteTask_1.handler)(event)];
                case 1:
                    result = _a.sent();
                    expect(mockClient.connect).toHaveBeenCalled();
                    expect(tasks_1.TaskServices).toHaveBeenCalledWith(mockClient);
                    expect(mockTaskServices.getTaskById).toHaveBeenCalledWith(mockTask.id);
                    expect(response_1.response).toHaveBeenCalledWith(404, { message: "Not found task." });
    ...
    it("should return 200 and delete task", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    response_1.response.mockReturnValue({
                        statusCode: 200,
                        body: JSON.stringify({ message: "Task is deleted successfully." }),
                    });
                    event = {
                        pathParameters: {
                            id: mockTask.id,
                ...
                case 1:
                    ...
                    expect(tasks_1.TaskServices).toHaveBeenCalledWith(mockClient);
                    expect(mockTaskServices.getTaskById).toHaveBeenCalledWith(mockTask.id);
                    expect(mockTaskServices.deleteTaskById).toHaveBeenCalledWith(mockTask.id);
                    expect(response_1.response).toHaveBeenCalledWith(200, { message: "Task is deleted successfully." });
                    expect(result).toEqual({
                        statusCode: 200,
                        body: JSON.stringify({ message: "Task is deleted successfully." }),
                    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    mockTaskServices = {
                        getTaskById: jest.fn().mockResolvedValue(mockTask),
                        deleteTaskById: jest.fn().mockRejectedValue(error),
                    };
                    tasks_1.TaskServices.mockImplementation(function () { return mockTaskServices; });
                    // Mock its response what should be returned
                    response_1.response.mockReturnValue({
...
//# sourceMappingURL=deleteTask.spec.js.map