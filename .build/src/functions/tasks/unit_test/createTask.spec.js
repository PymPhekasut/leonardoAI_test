...
var mockTaskId = "14tg5g-cce9-453a-aa21-eee2fe2fb28e";
var mockTaskBody = {
    account_id: 101,
...
describe("handler", function () {
    ...
    it("should return 201 and create task", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, createTask_1.handler)(event)];
                case 1:
                    result = _a.sent();
                    ...
                    expect(response_1.response).toHaveBeenCalledWith(201, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    expect(tasks_1.TaskServices).toHaveBeenCalledWith(mockClient);
                    expect(mockTaskServices.insertTask).toHaveBeenCalledWith(mockTaskBody);
                    expect(response_1.response).toHaveBeenCalledWith(500, { error: error });
...
//# sourceMappingURL=createTask.spec.js.map