...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var client, taskId, taskServices, getTask, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                // Delete task
                return [4 /*yield*/, taskServices.deleteTaskById(taskId)];
            case 4:
                // Delete task
                _b.sent();
                return [2 /*return*/, (0, response_1.response)(200, { message: "Task is deleted successfully." })];
            case 5:
                error_1 = _b.sent();
