...
var getSchedule_1 = require("../getSchedule");
...
describe("handler", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, getSchedule_1.handler)(event)];
                case 1:
                    result = _a.sent();
    ...
    it("should return 200 and schedule", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(response_1.response).toHaveBeenCalledWith(200, { schedules: mockSchedule });
                    expect(result).toEqual({
                        statusCode: 200,
                        body: JSON.stringify({ schedules: mockSchedule }),
                    });
...
//# sourceMappingURL=getSchedule.spec.js.map