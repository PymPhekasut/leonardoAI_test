...
describe("handler", function () {
    ...
    it("should return 201 and create schedule", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, createSchedule_1.handler)(event)];
                case 1:
                    result = _a.sent();
...
//# sourceMappingURL=createSchedule.spec.js.map