...
var updateSchedule_1 = require("../updateSchedule");
...
var mockScheduleId = "02064d32-7109-487f-8aa0-97718eaef2aa";
var mockScheduleBody = {
    account_id: 129,
    agent_id: 80,
...
describe("handler", function () {
    ...
    it("should return 404 if no schedule found", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, updateSchedule_1.handler)(event)];
                case 1:
                    result = _a.sent();
    ...
    it("should return 200 and update schedule", function () { return __awaiter(void 0, void 0, void 0, function () {
        var event, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    expect(schedules_1.ScheduleServices).toHaveBeenCalledWith(mockClient);
                    expect(mockScheduleServices.getScheduleById).toHaveBeenCalledWith(mockScheduleId);
                    expect(mockScheduleServices.updateScheduleById).toHaveBeenCalledWith(mockScheduleId, mockScheduleBody);
                    expect(response_1.response).toHaveBeenCalledWith(200, {
...
//# sourceMappingURL=updateSchedule.spec.js.map