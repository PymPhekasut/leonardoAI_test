...
describe("handler", function () {
    ...
    //     const listSchedulesMock = jest.fn().mockResolvedValue([]);
    //     (ScheduleServices as jest.Mock).mockImplementation(() => ({
    ...
    it("should return 200 with list of schedules", function () { return __awaiter(void 0, void 0, void 0, function () {
        var schedules, listSchedulesMock, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    listSchedulesMock = jest.fn().mockResolvedValue(schedules);
                    schedules_1.ScheduleServices.mockImplementation(function () { return ({
                        listSchedules: listSchedulesMock,
                    }); });
                ...
                case 1:
                    ...
                    expect(listSchedulesMock).toHaveBeenCalled();
                    expect(response_1.response).toHaveBeenCalledWith(200, { schedules: schedules });
                    expect(result).toEqual({
                        statusCode: 200,
                        body: JSON.stringify({ schedules: schedules }), // Ensure the body is stringified
                    });
                    expect(mockClient.end).toHaveBeenCalled();
                    return [2 /*return*/];
            }
    ...
    //     const listSchedulesMock = jest.fn().mockRejectedValue(error);
    //     (ScheduleServices as jest.Mock).mockImplementation(() => ({
    //       listSchedules: listSchedulesMock,
    //     }));
    //     const event = {};
...
//# sourceMappingURL=schedules.spec.js.map